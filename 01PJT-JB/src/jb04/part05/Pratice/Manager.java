...
public class Manager extends Employee 
{
	...
	{		
		...
		System.out.println("M1=== 1 END ====\n");

		Manager m2 = new Manager("홍길동", "EJB");
		System.out.println("M2=== 2 END ====\n");

		Manager m3 = new Manager("홍길동", "EJB", 25);
		System.out.println("M3=== 3 END ====\n");

		Manager m4 = new Manager("홍길동", "EJB", 25, 300);
		System.out.println("M4=== 4 END ====\n");

		Manager m5 = new Manager();
		System.out.println("M5=== 5 END ====\n");
