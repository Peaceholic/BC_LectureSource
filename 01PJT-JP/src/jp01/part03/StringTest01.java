...
public class  StringTest01{
	...
	public static void main(String[] args)	{
		...
		// == 비교
		System.out.println("s1==s2 : "+(s1==s2)); // T >> FWP
		...
		// equals() 비교
		System.out.println("s1.equals(s2) : "+s1.equals(s2)); // t String 클레스 equals 는 override 됨  
		System.out.println("s1.equals(s3) : "+s1.equals(s3)); // t (일반 Object 클레스 equals 는 override 되지 않아 F 반환)
