...
public class CalendarTest{
	...
	public static void main(String args[])	{
		...
		System.out.println(cld.get(Calendar.YEAR)+"년의: " + cld.get(Calendar.WEEK_OF_YEAR)+"번째주");
		System.out.println(cld.get(Calendar.YEAR)+"년의: " + cld.get(Calendar.WEEK_OF_MONTH)+"번째달");
		System.out.println("이번달의 : "+cld.get(Calendar.DAY_OF_MONTH)+"번째일");
		System.out.println(cld.get(Calendar.YEAR)+"년의: "+ cld.get(Calendar.DAY_OF_YEAR)+"번째일");
