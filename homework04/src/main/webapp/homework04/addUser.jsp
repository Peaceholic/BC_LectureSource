...
<%@ page import="homework04.UserDao" %>
	...
	<h2> homework04 Add User 회원가입 </h2>
	...
	<%	}%>
		<br><br>
		<p><p><a href='/homework04/homework04/addUser.html'> 회원가입 화면으로 이동</a>
		<p><p><a href='/homework04/homework04/findUser.html'> 회원조회 화면으로 이동</a>
		<p><p><a href='/homework04/homework04/'> Folder 이동</a>
		<br><br>

		<p><p><a href='/homework04/homework04/findUser.jsp'> 회원정보 보기 (Session 유지)</a>
		<br><br>
